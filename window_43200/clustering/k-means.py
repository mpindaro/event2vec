...
def grid_search():
    ...
    events_no_timestamp = filtered[
        ["event_type", "n_1a", "n_1b", "n_2", "n_3a", "n_3b", "n_3c", "n_4a", "n_4b", "n_4c", "n_4d", "n_1_comune",
         "n_2_comune"]]
    events_no_timestamp_and_optional = filtered[
        ["event_type", "n_1a", "n_1b", "n_2", "n_3a", "n_3b", "n_3c", "n_4a", "n_4b", "n_4c", "n_4d"]]
...
def read_inputs():
    ...
    parser.add_argument('community', type=int,
                        help='Numero della community richiesta, sono in ordine decrescente per size')
